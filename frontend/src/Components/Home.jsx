...
const Home = () => {
  ...
  useEffect(() => {
    axios
      .get(`${BASE}/api/v1/portfolio/templates/bulk`)
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2 space-y-8">
              ...
              <p className="text-gray-400 text-lg md:text-xl max-w-lg">
                Create a stunning portfolio website that showcases your work and
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-400 max-w-xl mx-auto text-lg">
              Everything you need to create a stunning portfolio website that
              stands out.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 p-8 rounded-xl hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 group">
              ...
              <p className="text-gray-400">
                Your portfolio looks perfect on all devices, from mobile phones
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 p-8 rounded-xl hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 group">
              ...
              <p className="text-gray-400">
                Publish your portfolio with a single click and share it with the
                world instantly.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-400 max-w-xl mx-auto text-lg">
              Choose from our collection of beautiful, ready-to-use portfolio
              templates.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
              Join thousands of professionals who are building impressive
              portfolios and landing more clients with our platform.
            </p>
